...
if ("$CHANNEL" -eq 'local') {
    ...
    $FEATURES = 'release_bundle,oss_minimal_assets,skip_firebase_anonymous_user,settings_file,tabbed_editor_view,file_tree,code_find_replace,rect_selection,ligatures,kitty_keyboard_protocol,trim_trailing_blank_lines'
}
