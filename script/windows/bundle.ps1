...
if ("$CHANNEL" -eq 'local') {
    ...
    $FEATURES = 'release_bundle,oss_slim,skip_login,skip_firebase_anonymous_user,settings_file,rect_selection,ligatures,kitty_keyboard_protocol,trim_trailing_blank_lines'
}
