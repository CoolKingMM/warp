...
fn zh_cn(text: &str) -> Option<&'static str> {
    Some(match text {
        ...
        "Close all tabs" => "关闭所有标签页",
        "Close Focused Panel" => "关闭当前面板",
        "Close focused panel" => "关闭当前面板",
        "Close Current Session" => "关闭当前会话",
        "Close project terminal" => "关闭项目终端",
        ...
        "Copy output" => "复制输出",
        "Copy output as Markdown" => "复制 Markdown 格式输出",
        "Copy pane title" => "复制窗格标题",
        "Copy path" => "复制路径",
        "Copy prompt" => "复制提示",
        "Copy pull request link" => "复制 Pull Request 链接",
        "Copy relative path" => "复制相对路径",
        "Copy session sharing link" => "复制会话分享链接",
        "Copy tab title" => "复制标签页标题",
        "Copy transcript to clipboard" => "复制转录到剪贴板",
        "Copy working directory" => "复制工作目录",
        "Copy Text Or Cancel Active Process" => "复制文本或取消当前进程",
        "Copy Text or Cancel Active Process" => "复制文本或取消当前进程",
        ...
        "Find in Terminal" => "在终端中查找",
        "Find within block" => "在块中查找",
        "Find within blocks" => "在多个块中查找",
        "Find Within Selected Block" => "在选中块中查找",
        "Finish" => "完成",
        ...
        "Left Panel: Project Explorer" => "左侧面板：项目资源管理器",
        "Left Panel: Project explorer" => "左侧面板：项目资源管理器",
        "Learn more" => "了解更多",
        "Load more" => "加载更多",
        "Loading..." => "加载中...",
        ...
        "Open global search" => "打开全局搜索",
        "Open Keybindings Editor" => "打开快捷键编辑器",
        "Open keybindings editor" => "打开快捷键编辑器",
        ...
        "Open Settings: Keyboard Shortcuts" => "打开设置：快捷键",
        "Open plan" => "打开计划",
        "Open Recent" => "打开最近项目",
        ...
        "Rename" => "重命名",
        "Rename Tab" => "重命名标签页",
        "Rename The Current Pane" => "重命名当前窗格",
        ...
        "Reinput Selected Commands" => "重新输入选中的命令",
        "Reinput selected commands" => "重新输入选中的命令",
        "Reinput Selected Commands as Root" => "以 root 重新输入选中的命令",
        "Reinput selected commands as root" => "以 root 重新输入选中的命令",
        ...
        "Save new launch configuration" => "保存新的启动配置",
        "Saving..." => "正在保存...",
        "Scroll Terminal Output Down One Line" => "向下滚动终端输出一行",
        "Scroll Terminal Output Down One Page" => "向下滚动终端输出一页",
        "Scroll Terminal Output Up One Line" => "向上滚动终端输出一行",
        "Scroll Terminal Output Up One Page" => "向上滚动终端输出一页",
        "Scroll to bottom of block" => "滚动到块底部",
        "Scroll to bottom of blocks" => "滚动到多个块底部",
        "Scroll To Bottom Of Selected Block" => "滚动到选中块底部",
        "Scroll to top of block" => "滚动到块顶部",
        "Scroll to top of blocks" => "滚动到多个块顶部",
        "Scroll To Top Of Selected Block" => "滚动到选中块顶部",
        "Scroll to Bottom of Selected Block" => "滚动到选中块底部",
        "Scroll to Top of Selected Block" => "滚动到选中块顶部",
        "Search" => "搜索",
        ...
        "Toggle block filter" => "切换块筛选",
        "Toggle Block Filter on Selected or Last Block" => "切换选中块或最后一个块的筛选",
        "Toggle block filter on selected or last block" => "切换选中块或最后一个块的筛选",
        ...
        "Toggle fullscreen" => "切换全屏",
        "Toggle Hidden Files In Project Explorer" => "显示或隐藏项目资源管理器中的隐藏文件",
        "Toggle Hidden Files in Project Explorer" => "显示或隐藏项目资源管理器中的隐藏文件",
        "Toggle hidden files in Project Explorer" => "显示或隐藏项目资源管理器中的隐藏文件",
        "Toggle Keyboard Shortcuts" => "切换快捷键页面",
        "Toggle keyboard shortcuts" => "切换快捷键页面",
        "Toggle Maximize Active Pane" => "最大化或还原当前窗格",
        "Toggle Navigation Palette" => "切换导航面板",
        "Toggle navigation palette" => "切换导航面板",
        "Toggle project explorer" => "切换项目资源管理器",
        "Toggle Sticky Command Header" => "切换命令粘性标题",
        "Toggle sticky command header" => "切换命令粘性标题",
        "Toggle Vertical Tabs Panel" => "切换竖向标签面板",
        "Toggle vertical tabs panel" => "切换竖向标签面板",
        "Theme name" => "主题名称",
        " to cycle tabs" => " 切换标签",
        " to dismiss" => " 关闭",
        ...
        "[Debug] Enter Onboarding State" => "调试：进入引导状态",
        "[Debug] Generate codebase index" => "调试：生成代码库索引",
        "[Debug] Install OpenCode Warp plugin" => "调试：安装 OpenCode Warp 插件",
        ...
        "[Debug] Open Build Plan Migration Modal" => "调试：打开构建计划迁移窗口",
        "[Debug] Open OpenWarp Launch Modal" => "调试：打开 OpenWarp 启动窗口",
        "[Debug] Open Orchestration Launch Modal" => "调试：打开编排启动窗口",
        "[Debug] Open Oz Launch Modal" => "调试：打开 Oz 启动窗口",
        "[Debug] Open Session Config Modal" => "调试：打开会话配置窗口",
        "[Debug] Reset Build Plan Migration Modal State" => {
            "调试：重置构建计划迁移窗口状态"
        },
        "[Debug] Reset OpenWarp Launch Modal State" => "调试：重置 OpenWarp 启动窗口状态",
        "[Debug] Reset Orchestration Launch Modal State" => {
            "调试：重置编排启动窗口状态"
        },
        "[Debug] Reset Oz Launch Modal State" => "调试：重置 Oz 启动窗口状态",
        "[Debug] Start HOA Onboarding Flow" => "调试：启动 HOA 引导流程",
        "[Debug] Un-dismiss AWS login banner" => "调试：恢复 AWS 登录横幅",
        ...
        "Add cursor below" => "在下方添加光标",
        "Add repository" => "添加仓库",
        "Add selection for next occurrence" => "添加下一个匹配项到选择",
        "Alternate terminal paste" => "备用终端粘贴",
        "Ask Warp AI about last block" => "询问 Warp AI 上一个块",
        "Ask Warp AI about Selection" => "询问 Warp AI 所选内容",
        "Backward tabulation within an executing command" => "在执行中的命令内向后制表",
        "Bookmark selected block" => "为选中块添加书签",
        "Clear and reset AI context menu query" => "清空并重置 AI 上下文菜单查询",
        "Clear command editor" => "清空命令编辑器",
        "Clear screen" => "清屏",
        "Clear selected lines" => "清除选中行",
        "Copy access token to clipboard" => "复制访问令牌到剪贴板",
        "Copy and clear selected lines" => "复制并清除选中行",
        "Copy git branch" => "复制 Git 分支",
        "Copy rich-text buffer" => "复制富文本缓冲区",
        "Copy rich-text selection" => "复制富文本所选内容",
        "Create or edit link" => "创建或编辑链接",
        "Cursor at buffer end" => "光标到缓冲区末尾",
        "Cursor at buffer start" => "光标到缓冲区开头",
        ...
        "Decrease notebook font size" => "减小 Notebook 字体",
        "Decrease font size" => "减小字体",
        ...
        "Dump heap profile (can only be done once)" => "导出堆配置文件（只能执行一次）",
        "End" => "行尾",
        "Exit Vim insert mode" => "退出 Vim 插入模式",
        "Expand selected blocks above" => "向上扩展选中块",
        "Expand selected blocks below" => "向下扩展选中块",
        "Export all Warp Drive objects" => "导出所有 Warp Drive 对象",
        "Find in Notebook" => "在 Notebook 中查找",
        "Find in code editor" => "在代码编辑器中查找",
        "Find the next occurrence of your search query" => "查找下一个匹配项",
        "Find the previous occurrence of your search query" => "查找上一个匹配项",
        "Find within selected block" => "在选中块中查找",
        "Focus next match" => "聚焦下一个匹配项",
        "Focus previous match" => "聚焦上一个匹配项",
        ...
        "Invite People..." => "邀请成员...",
        "Join our Slack community (opens external link)" => "加入 Slack 社区（打开外部链接）",
        "Jump to latest agent message" => "跳转到最新 Agent 消息",
        "Jump to latest agent task" => "跳转到最新 Agent 任务",
        "Launch configuration palette" => "打开启动配置面板",
        "Load agent mode conversation (from debug link in clipboard)" => {
            "加载 Agent 模式会话（来自剪贴板中的调试链接）"
        },
        ...
        "Move cursor end within an executing command" => "在执行中的命令内移动光标到行尾",
        "Move cursor home within an executing command" => "在执行中的命令内移动光标到行首",
        ...
        "Move cursor to the bottom" => "移动光标到底部",
        "Move cursor to the top" => "移动光标到顶部",
        "Move cursor up" => "向上移动光标",
        "Move forward one word" => "向前移动一个单词",
        "Move to end of line" => "移动到行尾",
        "Move to end of paragraph" => "移动到段落末尾",
        "Move to line end" => "移动到行尾",
        "Move to line start" => "移动到行首",
        "Move to start of line" => "移动到行首",
        "Move to the end of the buffer" => "移动到缓冲区末尾",
        "Move to the end of the paragraph" => "移动到段落末尾",
        "Move to the start of the buffer" => "移动到缓冲区开头",
        "Move to the start of the paragraph" => "移动到段落开头",
        ...
        "Reset notebook font size" => "重置 Notebook 字体",
        "Reset font size to default" => "重置字体为默认大小",
        "Reset zoom level to default" => "重置缩放为默认级别",
        "Resize pane > Move divider down" => "调整窗格大小 > 向下移动分隔线",
        "Resize pane > Move divider left" => "调整窗格大小 > 向左移动分隔线",
        "Resize pane > Move divider right" => "调整窗格大小 > 向右移动分隔线",
        "Resize pane > Move divider up" => "调整窗格大小 > 向上移动分隔线",
        "Run selected commands" => "运行选中的命令",
        "Sample Process" => "采样进程",
        "Save all unsaved files in code review" => "保存代码审查中的所有未保存文件",
        "Save file as" => "文件另存为",
        "Save workflow" => "保存工作流",
        "Scroll down half a page (vim)" => "向下滚动半页（vim）",
        "Scroll terminal output down one line" => "向下滚动终端输出一行",
        "Scroll terminal output down one page" => "向下滚动终端输出一页",
        "Scroll terminal output up one line" => "向上滚动终端输出一行",
        "Scroll terminal output up one page" => "向上滚动终端输出一页",
        "Scroll to bottom of selected block" => "滚动到选中块底部",
        "Scroll to top of selected block" => "滚动到选中块顶部",
        "Scroll up half a page (vim)" => "向上滚动半页（vim）",
        ...
        "Stop Synchronizing Any Panes" => "停止同步任何窗格",
        "Stop sharing current session" => "停止分享当前会话",
        "Switch Focus to Left Panel" => "切换焦点到左侧面板",
        "Switch Focus to Right Panel" => "切换焦点到右侧面板",
        "Switch panes down" => "切换到下方窗格",
        "Switch panes left" => "切换到左侧窗格",
        "Switch panes right" => "切换到右侧窗格",
        "Switch panes up" => "切换到上方窗格",
        "Terminal session" => "终端会话",
        "Toggle Maximize Code Review Panel" => "最大化或还原代码审查面板",
        "Toggle PTY Recording for Session" => "切换当前会话 PTY 录制",
        "Toggle Sticky Command Header in Active Pane" => "切换当前窗格命令粘性标题",
        "Toggle Synchronizing All Panes in All Tabs" => "切换所有标签页中全部窗格的同步",
        "Toggle Synchronizing All Panes in Current Tab" => "切换当前标签页中全部窗格的同步",
        "Toggle Conversation Details Panel" => "切换会话详情面板",
        ...
        "[a11y] Set concise accessibility announcements" => "设置简洁辅助功能播报",
        "[a11y] Set verbose accessibility announcements" => "设置详细辅助功能播报",
